(() => {
  ...
  */
  ...
  const DRIVER_TUNE = {
    2:  { artX: 16, primaryX: -14, primaryY: 18, primaryScaleMult: 1.10 },
    3:  { primaryX: -28, primaryScaleMult: 1.10 },
    4:  { artX: 14, primaryX: 0, primaryY: 54 },
    5:  { artX: 18 },
    6:  { artX: 10 },
    7:  { artX: 24, primaryX: 14, primaryY: 22 },
    8:  { artX: 24 },
    9:  { artX: 24, primaryX: -24, primaryY: 70 },
    10: { artX: 14, primaryX: -12 },
    11: { artX: 22, primaryX: -20, primaryY: 110 },
    13: { primaryScaleMult: 1.15 },
    14: { secondaryY: 14 },
    15: { artX: 14 },
    16: { groupX: -12 },
    17: { secondaryY: 14 },
