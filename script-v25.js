(() => {
  ...
  */
  ...
  const DRIVER_TUNE = {
    2:  { artX: 16, primaryX: -14, primaryY: 78, primaryScaleMult: 1.10 },
    3:  { primaryX: -62, primaryScaleMult: 1.18 },
    4:  { artX: 24, primaryX: 0, primaryY: 152 },
    5:  { artX: 30, primaryX: -18, primaryScaleMult: 1.07 },
    6:  { artX: 8, primaryX: -18, primaryScaleMult: 1.12 },
    7:  { artX: 50, artScale: 0.95, primaryX: -24, primaryY: 92 },
    8:  { artX: 32, primaryX: -18, primaryScaleMult: 1.08 },
    9:  { artX: 22, primaryX: -24, primaryY: 86 },
    10: { artX: 18, artScale: 0.95, primaryX: -24, primaryScaleMult: 1.15 },
    11: { artX: 26, primaryX: -20, primaryY: 120 },
    12: { artX: 6, primaryScaleMult: 0.95 },
    13: { artX: -6, primaryScaleMult: 1.15, primaryY: 26 },
    14: { secondaryY: 14 },
    15: { artX: 14 },
    16: { groupX: -12 },
    17: { secondaryY: 14 },
