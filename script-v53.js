  ...
  function ensureSocialV53() {
    ...
    section.innerHTML = `
      ...
      <div class="social-grid">
        <article class="social-card social-card-ameer" data-reveal><span class="social-number">01</span><div class="social-card-heading"><small>PROJECT DEVELOPER</small><h3>AMEER_007x</h3><p>Project development, original V8 content integration, website design, media, and community updates.</p></div><div class="social-links" aria-label="AMEER_007x contact links">
