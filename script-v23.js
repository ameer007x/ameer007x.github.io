(() => {
  ...
  */
  ...
  const DRIVER_TUNE = {
    2:  { artX: 28, primaryX: -14, primaryY: 54, primaryScaleMult: 1.10 },
    3:  { primaryX: -62, primaryScaleMult: 1.18 },
    4:  { artX: 38, primaryX: 0, primaryY: 124 },
    5:  { artX: 30, primaryX: -18, primaryScaleMult: 1.07 },
    6:  { artX: 20, primaryX: -18, primaryScaleMult: 1.06 },
    7:  { artX: 62, artScale: 0.95, primaryX: -24, primaryY: 92 },
    8:  { artX: 32, primaryX: -18, primaryScaleMult: 1.08 },
    9:  { artX: 32, primaryX: -24, primaryY: 86 },
    10: { artX: 28, artScale: 0.95, primaryX: -24, primaryScaleMult: 1.15 },
    11: { artX: 36, primaryX: -20, primaryY: 156 },
