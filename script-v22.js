(() => {
  ...
  */
  ...
  const DRIVER_TUNE = {
    2:  { artX: 28, primaryX: -14, primaryY: 34, primaryScaleMult: 1.10 },
    3:  { primaryX: -44, primaryScaleMult: 1.18 },
    4:  { artX: 24, primaryX: 0, primaryY: 76 },
    5:  { artX: 30, primaryX: -18, primaryScaleMult: 1.07 },
    6:  { artX: 20, primaryX: -18, primaryScaleMult: 1.06 },
    7:  { artX: 42, artScale: 0.95, primaryX: -8, primaryY: 46 },
    8:  { artX: 32, primaryX: -18, primaryScaleMult: 1.08 },
    9:  { artX: 32, primaryX: -24, primaryY: 86 },
    10: { artX: 28, artScale: 0.95, primaryX: -24, primaryScaleMult: 1.08 },
    11: { artX: 36, primaryX: -20, primaryY: 126 },
    12: { primaryScaleMult: 0.95 },
    13: { primaryScaleMult: 1.15, primaryY: 26 },
    14: { secondaryY: 14 },
    15: { artX: 14 },
    16: { groupX: -12 },
    17: { secondaryY: 14 },
    18: { secondaryY: 14 },
    19: { secondaryY: 14 },
    20: { primaryScale: 0.90, secondaryScale: 0.855, secondaryY: 14 },
    22: { secondaryY: 28 },
    23: { secondaryY: 14, secondaryX: 10 },
    26: { secondaryScale: 0.76, secondaryY: 12 },
    27: { artX: 32, artScale: 0.70, groupX: -24, secondaryY: 28 },
    28: { secondaryY: 14 },
